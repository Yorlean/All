...
CREATE TABLE `empleado` (
  ...
  `banco` enum('BBVS','davivienda','bancolombia','caja social','popular','las villas') DEFAULT NULL,
...
--
ALTER TABLE `proveedor`
  MODIFY `cod_proovedor` int(11) NOT NULL AUTO_INCREMENT;
